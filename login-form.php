...
<head>
    ...
    <title>Login | SIA Lab Activity 2</title>
    <style>
        ...
        *{box-sizing:border-box;font-family:Inter, system-ui, -apple-system, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif}
        ...
        .btn-login{background:var(--accent);color:#fff;border:none;padding:10px 16px;border-radius:8px;cursor:pointer;width:100%;font-size:14px;font-weight:600;transition:all 0.2s;margin-top:8px}
...
<body>
    <div class="container">
        <div class="card">
            ...
            <?php if ($msg != ""): ?>
                <div class="alert alert-<?php echo strpos($msg, 'successful') !== false || strpos($msg, 'Welcome') !== false ? 'success' : 'danger'; ?>">
            ...
            <div class="link-text">
                Don't have an account? <a href="registration-form.php">Register here</a>
            </div>
        </div>
    </div>
</body>
